...
export default function App() {
  ...
  // Smooth preloader loading sequence
  useEffect(() => {
    const steps = ["ARTISTRY", "INTUITION", "SOUL", "ÉLAN"];
    ...
    steps.forEach((_, idx) => {
      const t = setTimeout(() => {
        ...
        if (idx === steps.length - 1) {
          // Finish preloader slightly after final step
  ...
  const currentSteps = ["ARTISTRY", "INTUITION", "SOUL", "ÉLAN"];
      ...
      <AnimatePresence mode="wait">
        {loading ? (
          ...
          >
            ...
            {/* Persistent Dynamic Side Scroller */}
            <ScrollNavigation />
